...
from src.logic.constants.helpMenuContent import HOW_TO_PLAY_MENU_MESSAGE_SPA, SPECIAL_BROCCOLIS_MENU_MESSAGE_SPA

spanish = {
  # CONSOLE TEXT
  "InputTotalRows": "Número de filas:",
  "InputTotalColumns": "Número de columnas:",
  "InputTotalBroccolis": "Número de brócolis:",
  ...
  "Winning_Texts": ["Felicitaciones\nGanaste el juego!!",
                    ...
                    "Eso fue increible!",
                    "Pero que habilidos@!!"],
  "Game_Over_Texts": ["Lo siento perdiste",
  ...
  "HelpTabMenu": "Ayuda",
  "HowToPlayMenuLabel": "Como jugar",
  "HowToPlayMessage": HOW_TO_PLAY_MENU_MESSAGE_SPA,
  "SpecialBroccolisMenuLabel": "Brocolis especiales",
  "SpecialBroccolisMessage": SPECIAL_BROCCOLIS_MENU_MESSAGE_SPA,
  ...
  "ZeroBroccolisError": "# Brócolis no puede ser menor a 1",
  "BroccoliErrorLimit1": "# Brócolis no puede ser mayor a ",
