...
# For corners on last row or column,
#   it is handled as an increment but from negative index up to 0 index (not include)
#     the negative index being the last elements of the array
#   In other words, a corner on the last column starts
#     from the far-left corner space and increments until it reaches the last column
